...
def all(request):
    ...
    return render(request, 'alliancecrafts/all.html', context)
...
def getstatus(request, request_id):
    req = get_object_or_404(CraftingRequest, pk=request_id)
    return render(request, 'alliancecrafts/detail.html', {'req': req})
...
def addcraft(request):
    try:
        ...
        return HttpResponseRedirect('/alliancecrafts/')
        
    except MultiValueDictKeyError as e:
        return render(request, 'alliancecrafts/addcraft.html', {})
